...
function SearchPageContent() {
  ...
  const sourceCategory = searchParams.get('source') as 'normal' | 'adult' | null;
  ...
  return (
    <div className="min-h-screen bg-surface dark:bg-background">
      {/* Search Header */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-b border-surface-secondary">
      ...
      <main className="pt-14 pb-safe-bottom">
        ...
        {showResults && (
          <>
            ...
            <VODGrid items={data} loading={loading} columns={2} sourceCategory={sourceCategory || undefined} />
