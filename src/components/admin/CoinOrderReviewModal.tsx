...
/**
 * CoinOrderReviewModal Component
 * Review coin recharge orders
 */
...
export interface CoinOrderReviewModalProps {
    isOpen: boolean;
    onClose: () => void;
...
export function CoinOrderReviewModal({
    isOpen,
    onClose,
    order,
    getAccessToken,
    ...
    const handleApprove = useCallback(async () => {
        ...
        setProcessing(true);
        try {
            const response = await fetch(`/api/admin/coins/orders/${order.id}`, {
                method: 'PUT',
                headers: {
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4">
                    ...
                    <div className="bg-surface rounded-lg p-4 space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                            ...
                            <div>
                                <span className="text-foreground/50">用户ID</span>
                                <p>{order.userId.slice(0, 8)}</p>
                            </div>
                            <div>
