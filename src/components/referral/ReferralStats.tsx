        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <div className="text-white/60 text-sm mb-1">累计邀请</div>
                    <div className="text-2xl font-bold text-white">{stats?.inviteCount || 0} 人</div>
                </div>
                <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <div className="text-white/60 text-sm mb-1">获得奖励</div>
                    <div className="text-2xl font-bold text-yellow-500">{stats?.totalIncome || 0} coins</div>
                </div>
            </div>
            ...
            <div className="bg-white/5 rounded-xl p-6 border border-white/10 space-y-6">
                <div className="text-center">
                    <h3 className="text-white font-medium mb-4">扫描二维码邀请好友</h3>
                ...
                <div className="space-y-2">
                    <label className="text-sm text-white/60 block">我的邀请码</label>
                    <div className="flex bg-black/20 rounded-lg p-3 border border-white/10 items-center justify-between">
                        <span className="text-xl font-mono text-white tracking-wider">{user.referralCode}</span>
                        <button
                            onClick={() => {
                ...
                <div className="space-y-2">
                    <label className="text-sm text-white/60 block">推广链接</label>
                    <div className="flex gap-2">
                        <div className="flex-1 bg-black/20 rounded-lg p-3 text-sm text-white/80 border border-white/10 truncate">
                            {shareLink}
                        </div>
                        <button
                            onClick={handleCopy}
